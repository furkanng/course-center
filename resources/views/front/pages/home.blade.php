                        ...
                        <div class="slider__thumb-2 p-relative">
                            <div class="slider__shape">
                                ...
                                <img class="slider__shape-4"
                                     src="{{asset("front/assets/img/slider/2/shape/slider-shape-1.jpg")}}" alt="">
                                <img class="slider__shape-5"
                                     src="{{asset("front/assets/img/slider/2/shape/slider-shape-2.jpg")}}" alt="">
                            </div>
                            <span class="slider__thumb-mask">
                           <img src="{{asset("front/assets/img/slider/2/slider-thumb.png")}}" alt="">
                        </span>
                        </div>
                    </div>
                </div>
                            ...
                            <nav>
                                <div class="nav nav-tabs justify-content-center" id="course-tab" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-design-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">Design Architect
                                    </button>
                                </div>
                            </nav>
                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-1.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-1.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-2.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-2.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-3.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-3.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-4.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-4.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-5.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-5.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                                <div class="course__thumb-2 w-img fix">
                                                    <a href="course-details.html">
                                                        <img src="{{asset("front/assets/img/course/2/course-6.jpg")}}"
                                                             alt="">
                                                    </a>
                                                </div>
                                                <div class="course__content-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="course__tutor-2">
                                                            <a href="#">
                                                                <img
                                                                    src="{{asset("front/assets/img/course/tutor/course-tutor-6.jpg")}}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="research__wrapper-2">
                            ...
                            <p>Learn from anywhere in the world on desktop, or mobile phone with an Internet
                                connection.</p>
                                ...
                                <div class="research__content-2 p-relative z-index-1">
                                    ...
                                    <div class="research__store">
                                        <ul>
                                            <li>
                                                <a href="#"><img
                                                        src="{{asset("front/assets/img/icon/google-play-store.png")}}"
                                                        alt="google-play-store"> Google play</a>
                                            </li>
                                            <li>
                                                <a href="#"><img
                                                        src="{{asset("front/assets/img/icon/apple-store.png")}}"
                            ...
                            <div class="research__features-item d-sm-flex align-items-start mb-40">
                              ...
                              <span>
                                ...
                                <div class="research__features-content">
                                    <h4>eduker Online <br> Training from Experts </h4>
