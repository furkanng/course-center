                                ...
                                <div class="slider__content-3 p-relative z-index-1">
                                 <span data-animation="fadeInUp" data-delay=".3s">
                                    ...
                                    <div class="slider__list" data-animation="fadeInUp" data-delay="1.2s">
                                        <ul>
                                            <li><i class="fa-solid fa-check"></i> Access more then 120k online courses.
                                            </li>
                                            <li><i class="fa-solid fa-check"></i> Skilled and experienced coaches.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                            <ul>
                                <li><a href="course-v1.html">Python <i class="fa-regular fa-arrow-right"></i></a></li>
                                <li><a href="course-v1.html">Web Development <i
                                                class="fa-regular fa-arrow-right"></i></a></li>
                                <li><a href="course-v1.html">Machine Learning <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                        ...
                        <div class="category__list">
                            <ul>
                                ...
                                <li><a href="course-v1.html">Visual Studio Code <i
                                                class="fa-regular fa-arrow-right"></i></a></li>
                                <li><a href="course-v1.html">AWS Certification <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                            <ul>
                                <li><a href="course-v1.html">Advertising <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                                <li><a href="course-v1.html">UX Design <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                                <li><a href="course-v1.html">History of Art <i
                                                class="fa-regular fa-arrow-right"></i></a></li>
                                <li><a href="course-v1.html">Color & Form <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="category__btn-3">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                            <ul>
                                <li><a href="course-v1.html">Accounting <i class="fa-regular fa-arrow-right"></i></a>
                                </li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div
                            ...
                            <div class="app__item">
                                <a href="#" class="active">
                                    <span class="apple"><img src="assets/img/app/apple.png" alt=""></span>
                                    Apple Store
                                </a>
                            </div>
                        </div>
