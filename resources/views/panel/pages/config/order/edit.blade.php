...
@section('navigation-name')
    <h6 class="font-weight-bolder mb-0">Sipariş Detay</h6>
@endsection
                ...
                <div class="card-footer mt-md-5 mt-4">
                    <div class="row">
                        ...
                        <div class="col-lg-7 text-md-end mt-md-0 mt-3 btn-print">
                            <a href="{{route("panel.system.institutions.edit",["id" => $order->user_id])}}"
                               target="_blank">
                                <button class="btn bg-gradient-danger mt-lg-7 mb-0" type="button" name="button">
                                    Müşteri
                                </button>
                            </a>
                        ...
                        <x-confirm-modal modalId="confirmModal-{{ $order->id }}"
                                         title="Sipariş Onayı"
                                         body="Siparişi Onaylayıp reklamı başlatabilirsiniz"
                                         method="POST"
                                         button="Onayla"
                                         action="{{route('panel.config.orders.accept', ['order_id' => $order->id])}}"
                        >
                        </x-confirm-modal>
                    </div>
                </div>
