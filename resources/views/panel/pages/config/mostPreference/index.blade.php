...
@section('navigation-bar')
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">En Çok Tercih Edilenler</li>
@endsection
@section('navigation-name')
    <h6 class="font-weight-bolder mb-0">En Çok Tercih Edilenler Listesi</h6>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">En Çok Tercih Edilenler Kurumlar</h5>
                            <p class="text-sm mb-0">
                                Ana sayfadaki en çok tercih edilen kurumlar listesini düzenleyebilirsiniz.
                            </p>
                        </div>
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="{{route("panel.config.most-preference.create")}}"
                        ...
                        <table class="table table-flush" id="datatable-search">
                            ...
                            @foreach($companies as $company)
                                <tr>
                                    ...
                                    <td class="text-sm">
                                        <a href="{{route("panel.config.most-preference.edit",["id" => $company->id])}}"
                                           class="mx-3">
                                ...
                                <x-delete-modal modalId="deleteModal-{{ $company->id }}"
                                                ...
                                                action="{{ route('panel.config.most-preference.destroy', ['id' => $company->id]) }}">
                                </x-delete-modal>
                            @endforeach
                            </tbody>
                        </table>
