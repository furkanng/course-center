...
@section('navigation-bar')
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Misafir Ekle</li>
@endsection
@section('navigation-name')
    <h6 class="font-weight-bolder mb-0">Misafir Ekle</h6>
@endsection
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-3">
                    <form class="form-submit" method="POST"
                          action="{{route("panel.system.users.store")}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
