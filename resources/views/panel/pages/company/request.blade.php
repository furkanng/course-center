...
@section('navigation-name')
    <h6 class="font-weight-bolder mb-0">Bekleyen Talepler</h6>
@endsection
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-lg-flex align-items-center justify-content-between">
                        <div class="me-3">
                            <h5 class="mb-0">Kurum Talepleri</h5>
                            <p class="text-sm mb-0">
                                Talep edilmiş olan kurumları görebilirsiniz.
                            </p>
                        </div>
                    </div>
                        ...
                        <table class="table table-flush" id="products-list">
                            ...
                            @foreach($requests as $request)
                                <tr>
                                    ...
                                    <td class="text-sm">
                                        <span
                                            class="badge {{$request->new_company ? "badge-success": "badge-dark"}} badge-md">
                                            {{$request->new_company ? "Yeni Kurum": "Kayıtlı Kurum"}}
                                        </span>
                                    </td>
                                    <td class="text-sm">
                                    ...
                                    <td class="text-sm">
                                        <a href="{{route("panel.companies.request.edit",["id" => $request->id])}}">
