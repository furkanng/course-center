    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dashboardsExamples"
                   ...
                   aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                    ...
                    <span class="nav-link-text ms-1">Site Yönetimi</span>
                </a>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#pagesExamples"
                   ...
                   role="button" aria-expanded="false">
                    ...
                    <span class="nav-link-text ms-1">Sistem Yönetimi</span>
                </a>
            ...
            <li class="nav-item">
                ...
                {{ request()->routeIs("panel.setting.*") ? 'active' : '' }}"
                ...
                <div class="collapse {{ request()->routeIs('panel.setting.*') ? 'show' : '' }}"
                    ...
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('panel.setting.sms.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('panel.setting.sms.*') ? 'active' : '' }}"
                               href="{{route("panel.setting.sms.index")}}">
                                <span class="sidenav-mini-icon"> S </span>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#ecommerceExamples"
                   class="nav-link {{ request()->routeIs('panel.companies.*') ? 'active' : '' }}"
                ...
                <div class="collapse {{ request()->routeIs('panel.companies.*') ? 'show' : '' }}"
                     id="ecommerceExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('panel.companies.company.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('panel.companies.company.*') ? 'active' : '' }}"
                               href="{{route("panel.companies.company.index")}}">
                                <span class="sidenav-mini-icon"> K </span>
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ request()->routeIs('panel.reports.*') ? 'show' : '' }}" id="reports">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('panel.reports.companies.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('panel.reports.companies.*') ? 'active' : '' }}"
                               href="{{route("panel.reports.companies.index")}}">
