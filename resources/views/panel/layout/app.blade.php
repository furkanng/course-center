...
<head>
    ...
    <link rel="stylesheet" href="{{asset("panel/assets/vendors/ti-icons/css/themify-icons.css")}}">
...
<script src="{{asset("panel/assets/vendors/chart.js/chart.umd.js")}}"></script>
...
<script src="{{asset("panel/assets/js/jquery.cookie.js")}}"></script>
<!-- endinject -->
