        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#ecommerceExamples"
                   class="nav-link {{ request()->routeIs('merchant.companies.*') ? 'active' : '' }}"
                   aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    ...
                    <span class="nav-link-text ms-1">Kurum Yönetimi</span>
                </a>
                <div class="collapse {{ request()->routeIs('merchant.companies.*') ? 'show' : '' }}"
                     id="ecommerceExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('merchant.companies.company.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('merchant.companies.company.*') ? 'active' : '' }}"
                               href="{{route("merchant.companies.company.index")}}">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#account"
                   class="nav-link {{ request()->routeIs('merchant.account.*') ? 'active' : '' }}"
                   aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse {{ request()->routeIs('merchant.account.*') ? 'show' : '' }}"
                     id="account">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('merchant.account.profile.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('merchant.account.profile.*') ? 'active' : '' }}"
                               href="{{route("merchant.account.profile.index")}}">
                ...
                <div class="collapse {{ request()->routeIs('merchant.account.*') ? 'show' : '' }}"
                     id="account">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('merchant.account.order.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('merchant.account.order.*') ? 'active' : '' }}"
                               href="{{route("merchant.account.order.index")}}">
                                <span class="sidenav-mini-icon"> Ö </span>
                                <span class="sidenav-normal"> Ödemelerim </span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#contacts"
                   class="nav-link {{ request()->routeIs('merchant.contacts.*') ? 'active' : '' }}"
                   aria-controls="contacts" role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="collapse {{ request()->routeIs('merchant.contacts.*') ? 'show' : '' }}"
                     id="contacts">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('merchant.contacts.users.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('merchant.contacts.users.*') ? 'active' : '' }}"
                               href="{{route("merchant.contacts.users.index")}}">
                                <span class="sidenav-mini-icon"> M </span>
                                <span class="sidenav-normal"> Mesajlar </span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Raporlar</h6>
            </li>
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#reports"
                   class="nav-link {{ request()->routeIs('merchant.reports.*') ? 'active' : '' }}"
                ...
                <div class="collapse {{ request()->routeIs('merchant.reports.*') ? 'show' : '' }}" id="reports">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ request()->routeIs('merchant.reports.companies.*') ? 'active' : '' }}">
                            <a class="nav-link {{ request()->routeIs('merchant.reports.companies.*') ? 'active' : '' }}"
                               href="{{route("merchant.reports.companies.index")}}">
                                <span class="sidenav-mini-icon"> KR </span>
                                <span class="sidenav-normal"> Kurum Raporları </span>
                            </a>
                        </li>
                    </ul>
                </div>
