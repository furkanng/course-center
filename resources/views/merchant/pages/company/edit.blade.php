                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-4">
                            <div class="d-flex">
                                <form action="{{ route('merchant.companies.company.update', ['id' => $company->id]) }}"
                                      method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" name="website" type="text" value="{{$company->website}}"/>

                            <label class="mt-2">Telefon</label>
                            <input class="form-control" name="phone" id="phone" type="text"
                                   oninput="formatPhoneNumber(this)" maxlength="10" value="{{$company->phone}}"/>
        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <input class="form-control" type="text" name="facebook" value="{{$company->info?->facebook}}"/>
                    <label class="mt-2">Instagram</label>
                    <input class="form-control" type="text" name="instagram" value="{{$company->info?->instagram}}"/>
                    <label class="mt-2">X</label>
                    <input class="form-control" type="text" name="twitter" value="{{$company->info?->twitter}}"/>
                    <label class="mt-2">Youtube</label>
                    <input class="form-control" type="text" name="youtube" value="{{$company->info?->youtube}}"/>
                </div>
            </div>
        </div>
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                ...
                                <div class="d-flex">
                                    ...
                                    <x-sss-form-modal
                                        ...
                                        action="{{ route('merchant.companies.sss.update',['id' => $entity->id]) }}"
                                        method="PUT"
            ...
            <div class="card">
                <div class="card-header pb-0 p-3">
                    ...
                    <x-price-form-modal
                        ...
                        action="{{ route('merchant.companies.price.store',['company' => $company->id]) }}"
                        method="POST"
                        title=""
                        price=""
                        discounted=""
