...
@section('navigation-name')
    <h6 class="font-weight-bolder mb-0">Profil Bilgilerim</h6>
@endsection
    ...
    <div class="row mb-5 mt-4">
                ...
                <ul class="nav flex-column bg-white border-radius-lg p-3">
                    <li class="nav-item">
                        <a class="nav-link text-body" data-scroll="" href="#profile">
                            ...
                            <span class="text-sm">Genel Bilgiler</span>
                        </a>
                    </li>
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll="" href="#password">
                            ...
                            <span class="text-sm">Şifre Değiştirme</span>
                        </a>
                    </li>
                    {{--
                    <li class="nav-item pt-2">
        ...
        <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-auto col-4">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{\App\Service\Helper::getNoProfileImage()}}" alt="bruce"
                    ...
                    <div class="col-sm-auto col-8 my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-bold text-sm">
                                {{strtoupper($user->user_type->label())}}
                            </p>
                        </div>
                    </div>
            ...
            <div class="card mt-4" id="basic-info">
                ...
                <form class="form-update" action="{{route("merchant.account.profile.update")}}" method="POST">
                    @csrf
                    <div class="card-body pt-0">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" name="user_type" id="choices-gender" required>
                                    <option value="{{ \App\Enums\UserType::INSTITUTION_MANAGER->value }}"
                                        @selected($user->user_type == \App\Enums\UserType::INSTITUTION_MANAGER)>
                                        {{ \App\Enums\UserType::INSTITUTION_MANAGER->label() }}
                                    </option>
                                    <option value="{{ \App\Enums\UserType::INSTITUTION_WORKER->value }}"
                                        @selected($user->user_type == \App\Enums\UserType::INSTITUTION_WORKER)>
                                        {{ \App\Enums\UserType::INSTITUTION_WORKER->label() }}
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label class="form-label mt-4">Telefon Numarası</label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label class="form-label mt-4">İl</label>
                            ...
                            <div class="col-6">
                                <label class="form-label mt-4">İlçe</label>
            ...
            <div class="card mt-4" id="password">
                ...
                <form class="form-submit" action="{{route("merchant.account.profile.updatePassword")}}" method="POST">
                    @csrf

                    <div class="card-body pt-0">
                        <label class="form-label">Şuanki Şifreniz</label>
                        <div class="form-group">
                            <input class="form-control" name="current_password" type="password"
                                   placeholder="Şuanki şifreniz">
                        </div>
                        <label class="form-label">Yeni Şifreniz</label>
                        <div class="form-group">
                            <input class="form-control" type="password" name="password" placeholder="Yeni Şifreniz">
                        </div>
                        ...
                        <h5 class="mt-5">Şifre Gereksinimleri</h5>
                        <p class="text-muted mb-2">
                            Lütfen güçlü bir şifre belirleyiniz:
                        </p>
                        <ul class="text-muted ps-4 mb-0 float-start">
                            <li>
                                <span class="text-sm">En az 8 karakter uzunluğunda olmalıdır.</span>
                            </li>
                        </ul>
                        <button class="btn bg-gradient-dark btn-sm float-end mt-6 mb-0">Şifremi Güncelle</button>
                    </div>
                </form>
            </div>
            <!-- Card Change Password
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="ps-5 pt-3 ms-3">
                        ...
                        <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                            ...
                            <input class="form-control form-control-sm ms-sm-auto mt-sm-0 mt-2 w-sm-15 w-40" type="text"
                                   value="1172913" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy!">
                        </div>
                        <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                            ...
                            <tr>
                                <td class="ps-1" colspan="4">
                                    <div class="my-auto">
                                        ...
                                        <span
                                            class="text-xs font-weight-normal">Notify when another user follows you.</span>
                                    </div>
                                </td>
                                <td>
                                    <div
            ...
            <div class="card mt-4" id="delete">
                <div class="card-header">
                    <h5>Hesabımı Sil</h5>
                    <p class="text-sm mb-0">Hesabınızı sildikten sonra size ait olan kurumlar boşa çıkacaktır. Emin
                        misiniz ? </p>
                </div>
                <form class="form-submit" action="{{route("merchant.account.profile.delete")}}" method="POST">
                    @csrf
                    <div class="card-body d-sm-flex pt-0">
                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                            ...
                            <div class="ms-2">
                                <span class="text-dark font-weight-bold d-block text-sm">Onaylıyorum</span>
                                <span class="text-xs d-block">Hesabımı silmek istiyorum.</span>
                            </div>
                        </div>
                        <button class="btn bg-gradient-danger mb-0 ms-auto" type="submit" name="button">Hesabımı Sil
                        </button>
                    </div>
                </form>
            </div>
